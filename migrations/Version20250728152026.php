 ...
 */
final class Version20250728152026 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__index_link AS SELECT id, name, image, url FROM index_link');
        ...
        $this->addSql('INSERT INTO index_link (id, name, image, url) SELECT id, name, image, url FROM __temp__index_link');
